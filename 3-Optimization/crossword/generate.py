...
class CrosswordCreator():
    ...
    def enforce_node_consistency(self):
        ...
        for variable in self.domains:
            copy_domain = list(self.domains[variable])
            for word in copy_domain:
            ...
            if self.revise(x, y):
                ...
                for variable_x in self.domains:
                    for variable_y in self.domains:
                        if variable_x == variable_y:
                            continue
                        if variable_x == x or variable_y == x:
                            queue.append((variable_x, variable_y))
        return True
    ...
    def consistent(self, assignment):
        ...
        for variable in assignment:
            ...
            for each in assignment:
                word2 = assignment[each]
                if each == variable:
                    continue
                if word2 == word1:
                    return False
                overlap = self.crossword.overlaps[variable, each]
                if overlap:
    ...
    def backtrack(self, assignment):
        """
        Using Backtracking 0-Search, take as input a partial assignment for the
