...
def main():
    ...
    people = {
        'Harry': {'name': 'Harry', 'mother': 'Lily', 'father': 'James', 'trait': True},
    ...
    for person in names:
        if people[person]["mother"] != None:
            if people[person]["mother"] in one_gene:
                ...
                prob_nm = PROBS["mutation"]
            else:
                prob_m = PROBS["mutation"]
                prob_nm = 1 - PROBS["mutation"]
            ...
            if people[person]["father"] in one_gene:
                ...
                prob_nf = PROBS["mutation"]
            else:
                prob_f = PROBS["mutation"]
                prob_nf = 1 - PROBS["mutation"]
        ...
        if person in one_gene:
            if people[person]["mother"] == None:
                ...
                print(prob_m)
                print(prob_f)
                probability *= prob_m * prob_nf + prob_nm * prob_f
